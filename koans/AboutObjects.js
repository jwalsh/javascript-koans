describe(
    ...
    function() {
      ...
      it('should confirm that when a function is attached to an object, ' +
      ...
      it('should use prototype to add to all objects',
         function() {
           ...
           expect(simpleCircle.describe())
           .toBe('This circle has a radius of: 10');
           expect(colouredCircle.describe())
           .toBe('This circle has a radius of: 5');
         });
    });
